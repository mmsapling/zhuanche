...
public class IdentityCheckUI extends BaseActivity implements OnClickListener
{
	...
	public void initView()
	{
		...
		mIvExample = (ImageView) findViewById(R.id.ic_iv_example);
		mIvExample1 = (ImageView) findViewById(R.id.ic_iv_example1);
		mIvExample2 = (ImageView) findViewById(R.id.ic_iv_example2);
		mIvExample1.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v)
			{
				startActivity(ShowImgUI.class);
			}
		});
		mIvExample2.setOnClickListener(new OnClickListener() {
	...
	public void initData()
	{
		...
		mIvExample.setVisibility(0);
		mIvExample1.setVisibility(0);
		mIvExample2.setVisibility(0);
